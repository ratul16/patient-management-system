  ...
  <div class="login">
    <div class="login-form">
      <div>
        ...
        <p>Welcome back! Select your login methods</p>
        <b-form>
          <b-row align-v="start" align-h="between">
            ...
            <b-col md="12" sm="12">
              <div class="form-group">
                ...
                <b-form-input v-model="user.phone" type="password"></b-form-input>
              </div>
            </b-col>
            <b-col md="12" sm="12">
              <b-form-checkbox
        ...
        <div class="text-center mt-4">
          <p>
            ...
            <b-link :to="{ name: 'register' }" variant="primary" link> Create an account </b-link>
          </p>
        </div>
      </div>
    </div>
